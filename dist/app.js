...
(function(React, _) {
    ...
    document.onready = function() {
        ...
        React.render(React.createElement(Crossword, {title: data.gridinfo.name, clues: data.clues, numbered: data.numbered, cells: data.cells, size: data.gridinfo.size}), document.getElementById('app'));
    };
}(React, _));

},{"./components/Crossword.jsx":5}],2:[function(require,module,exports){
...
},{"../models/Crossword.js":6,"./Cell.jsx":2}],4:[function(require,module,exports){
(function (React, module, undefined) {
  module.exports = React.createClass({displayName: "exports",
    ...
    render: function () {
      ...
      var templated = Object.keys(this.props.clues).map(function(clueId) {
        ...
        return (
          React.createElement("li", {className: "clue-container"}, 
            ...
            return (
                React.createElement("div", {className: "row"}, 
                  ...
                  React.createElement("div", {className: "col-xs-4"}, 
                    React.createElement(ClueList, {direction: "ACROSS", clues: this.props.clues.Across}), 
                    React.createElement(ClueList, {direction: "DOWN", clues: this.props.clues.Down})
                  )
                )
            );
        }
...
},{"./Cells.jsx":3,"./ClueList.jsx":4}],6:[function(require,module,exports){
